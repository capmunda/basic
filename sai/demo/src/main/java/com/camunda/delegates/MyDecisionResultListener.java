...
public class MyDecisionResultListener implements ExecutionListener {
	...
	public void notify(DelegateExecution execution) throws Exception {
		...
		VariableMap variables = Variables.createVariables().putValue("beverage", "juice");

		DmnDecisionTableResult deb = ds.evaluateDecisionTableByKey("DecideBeverage", variables);
		// DmnDecisionTableResult der = deb.evaluate();
		Object result = deb.getSingleEntry();
